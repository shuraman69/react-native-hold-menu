...
export const calculateMenuHeight = (itemLength, separatorCount, maxVisibleItems) => {
  'worklet';
  ...
  return MenuItemHeight() * visibleLength + (visibleLength - 1) + visibleSeparatorCount * styleGuide.spacing;
};
export const menuAnimationAnchor = (anchorPoint, itemWidth, itemLength, itemsWithSeparatorLength, maxVisibleItems) => {
  'worklet';
